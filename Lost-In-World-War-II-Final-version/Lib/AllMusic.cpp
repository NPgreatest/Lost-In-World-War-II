...
void AllMusic::AddHitMusic()
{
    ...
    for (i = 0; i < MEDIA_MAX; i++)
    {
        ...
        {
        case 1:
            HitMusic[i].setMedia(QUrl("qrc:/sounds/sounds/hit1.mp3"));
            break;
        case 2:
            HitMusic[i].setMedia(QUrl("qrc:/sounds/sounds/hit2.mp3"));
            break;
        case 3:
            HitMusic[i].setMedia(QUrl("qrc:/sounds/sounds/hit3.mp3"));
            break;
        case 4:
            HitMusic[i].setMedia(QUrl("qrc:/sounds/sounds/hit4.mp3"));
            break;
        default:
            HitMusic[i].setMedia(QUrl("qrc:/sounds/sounds/hit5.mp3"));
            break;
        }
    }
}
void AllMusic::PlayHitMusic(int x)
{
    ...
    for (i = 0; i < MEDIA_MAX; i++)
    {
        if (HitMusic[i].state() == QMediaPlayer::PlayingState)
            continue;
...
void AllMusic::AddHit2Music()
{
    ...
    for (i = 0; i < MEDIA_MAX; i++)
    {
        ...
        {
        case 1:
            Hit2Music[i].setMedia(QUrl("qrc:/sounds/sounds/explo1.mp3"));
            break;
        case 2:
            Hit2Music[i].setMedia(QUrl("qrc:/sounds/sounds/explo2.mp3"));
            break;
        case 3:
            Hit2Music[i].setMedia(QUrl("qrc:/sounds/sounds/explo3.mp3"));
            break;
        case 4:
            Hit2Music[i].setMedia(QUrl("qrc:/sounds/sounds/explo4.mp3"));
            break;
        default:
            Hit2Music[i].setMedia(QUrl("qrc:/sounds/sounds/explo5.mp3"));
            break;
        }
    }
}
void AllMusic::PlayHit2Music(int x)
{
    ...
    for (i = 0; i < MEDIA_MAX; i++)
    {
        if (Hit2Music[i].state() == QMediaPlayer::PlayingState)
            continue;
...
void AllMusic::PlayRedZoneMusic(int x)
{
    ...
    for (i = 0; i < MEDIA_MAX; i++)
    {
        if (RedZoneMusic[i].state() == QMediaPlayer::PlayingState)
            continue;
