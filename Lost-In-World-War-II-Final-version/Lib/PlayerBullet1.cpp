...
void PlayerBullet1::Init(QRect const MeRect, HEAD const h, int const type, int const Damage, Target target, int master, int Speed)
{
    ...
    {
    case 1:
        MeImage.load(":/Images/Tank/Shot.png");
        break;
    case 2:
        MeImage.load(":/Images/Tank/Shot2.png");
        break;
    case 3:
        MeImage.load(":/Images/Tank/Shot3.png");
        break;
    case 4:
        MeImage.load(":/Images/Tank/Shot4.png");
        break;
    default:
        MeImage.load(":/Images/Tank/Shot.png");
        break;
...
void PlayerBullet1::PlayerBullet1_Move()
{
    ...
    {
    case UP:
        this->MeRect.adjust(0, -Speed, 0, -Speed);
        break;
    case DOWN:
        this->MeRect.adjust(0, Speed, 0, Speed);
        break;
    case LEFT:
        this->MeRect.adjust(-Speed, 0, -Speed, 0);
        break;
    case RIGHT:
        this->MeRect.adjust(Speed, 0, Speed, 0);
        break;
