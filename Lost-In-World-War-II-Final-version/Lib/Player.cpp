...
void Player::UpdateIm(HEAD head)
{
    if (slow || this->Choose == 1)
        ...
        {
        case UP:
            MeImage.load(":/Images/Tank/TankUp_2.png");
            break;
        case DOWN:
            MeImage.load(":/Images/Tank/TankDown_2.png");
            break;
        case LEFT:
            MeImage.load(":/Images/Tank/TankLeft_2.png");
            break;
        case RIGHT:
            MeImage.load(":/Images/Tank/TankRight_2.png");
            break;
        }
    else
        switch (head)
        ...
        case UP:
            ...
            break;
        case DOWN:
            MeImage.load(":/Images/Tank/TankDown.png");
            break;
        case LEFT:
            MeImage.load(":/Images/Tank/TankLeft.png");
            break;
        case RIGHT:
            MeImage.load(":/Images/Tank/TankRight.png");
            break;
        }
}
...
bool Player::Player_B3Fire(bool gua)
{
    ...
    {
    case UP:
        temp.adjust(-50, -100, 60, -40);
        B3.Init(temp, 10);
        break;
    case DOWN:
        temp.adjust(-50, 40, 60, 100);
        B3.Init(temp, 10);
        break;
    case LEFT:
        temp.adjust(-100, -50, -40, 60);
        B3.Init(temp, 10);
        break;
    case RIGHT:
        temp.adjust(40, -50, 110, 60);
        B3.Init(temp, 10);
        break;
    }
    return true;
