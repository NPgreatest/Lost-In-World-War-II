...
Partical::Partical(XY p,XY a,Type type)
    ...
    case Player_B3:MeImage.load(":/Images/Particals/Shot3_1.png");flash_max=8;break;
...
void Partical::FLash(){
    ...
    case Player_B3:
        ...
        case 4:MeImage.load(":/Images/Particals/Shot3_4.png");break;
            case 5:MeImage.load(":/Images/Particals/Shot3_5.png");break;
            case 6:MeImage.load(":/Images/Particals/Shot3_6.png");break;
            case 7:MeImage.load(":/Images/Particals/Shot3_7.png");break;
            case 8:MeImage.load(":/Images/Particals/Shot3_8.png");break;
        default:break;
        } break;
    case Player_Damage:
        switch (flash) {
