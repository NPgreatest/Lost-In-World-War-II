    ...
    ui(new Ui::Setting)
{
    ...
    if(!file.open(QIODevice::ReadOnly)){    //默认构造settings.txt
...
void Setting::Label_Tick(){
    ...
    case 0:
        ...
        break;
    case 1:if(ui->l1->text()==" ")ui->l1->setText(key.at(chose-1));else ui->l1->setText(" ");break;
    case 2:if(ui->l2->text()==" ")ui->l2->setText(key.at(chose-1));else ui->l2->setText(" ");break;
    case 3:if(ui->l3->text()==" ")ui->l3->setText(key.at(chose-1));else ui->l3->setText(" ");break;
    case 4:if(ui->l4->text()==" ")ui->l4->setText(key.at(chose-1));else ui->l4->setText(" ");break;
    case 5:if(ui->l5->text()==" ")ui->l5->setText(key.at(chose-1));else ui->l5->setText(" ");break;
    case 6:if(ui->l6->text()==" ")ui->l6->setText(key.at(chose-1));else ui->l6->setText(" ");break;
    case 7:if(ui->l7->text()==" ")ui->l7->setText(key.at(chose-1));else ui->l7->setText(" ");break;
    }
}
...
void Setting::keyPressEvent(QKeyEvent *event){
    QString t;
    t.setNum(event->key());
    if(chose<1||chose>7)return;
    if(event->text()!=""&&event->text()!=" ")
    key.replace(chose-1,event->text());
    else
    key.replace(chose-1,"Key:"+t);
    switch (chose) {
    case 1:settings.W=event->key();break;
    case 2:settings.S=event->key();break;
    case 3:settings.A=event->key();break;
    case 4:settings.D=event->key();break;
    case 5:settings.Shift=event->key();break;
    case 6:settings.Space=event->key();break;
    case 7:settings.L=event->key();break;
    default:break;
    }
}
