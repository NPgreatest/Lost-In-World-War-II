...
void Wall::SetStatue(int x){
    ...
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Wall1.png");break;
    case 1:MeImage.load(":/Images/Object/Wall2.png");break;
    case 2:MeImage.load(":/Images/Object/Wall3.png");break;
    default:break;
    }
}
bool Wall::Hit(){
...
void BedRock::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/BedRock1.png");break;
    case 1:MeImage.load(":/Images/Object/BedRock2.png");break;
    default:break;
    }
}
...
void Portal::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Portal.png");break;
    case 1:MeImage.load(":/Images/Object/Portal2.png");break;
    default:break;
    }
}
Camp::Camp(QRect MeRect,int skin,int HP):Object(MeRect,skin,5){
    ...
    Alive=true;
    switch (skin) {
    case 1:Remain=3;MeImage.load(":/Images/Object/Camp1.jpg");this->Status=0;break;
    case 2:Remain=5;MeImage.load(":/Images/Object/Camp2.jpg");this->Status=1;break;
    case 3:Remain=7;MeImage.load(":/Images/Object/Camp3.jpg");this->Status=2;break;
    default:break;
    }
}
...
void Camp::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Camp1.jpg");break;
    case 1:MeImage.load(":/Images/Object/Camp2.jpg");break;
    case 2:MeImage.load(":/Images/Object/Camp3.jpg");break;
    default:break;
    }
}
...
FirstAid::FirstAid(QRect MeRect,int skin):Object(MeRect,skin,6){
    Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/FirstAid1.png");this->Status=0;break;
    case 2:MeImage.load(":/Images/Object/FirstAid2.png");this->Status=1;break;
    case 3:MeImage.load(":/Images/Object/FirstAid3.png");this->Status=2;break;
    default:break;
    }
}
void FirstAid::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/FirstAid1.png");break;
    case 1:MeImage.load(":/Images/Object/FirstAid2.png");break;
    case 2:MeImage.load(":/Images/Object/FirstAid3.png");break;
    default:break;
    }
}
Weapon::Weapon(QRect MeRect,int skin):Object(MeRect,skin,7){
    Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/Weapon1.png");this->Status=0;break;
    case 2:MeImage.load(":/Images/Object/Weapon2.png");this->Status=1;break;
    case 3:MeImage.load(":/Images/Object/Weapon3.png");this->Status=2;break;
    default:break;
    }
}
void Weapon::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Weapon1.png");break;
    case 1:MeImage.load(":/Images/Object/Weapon2.png");break;
    case 2:MeImage.load(":/Images/Object/Weapon3.png");break;
    default:break;
    }
}
...
void Nail::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Nail1.png");break;
    case 1:MeImage.load(":/Images/Object/Nail2.png");break;
    default:break;
    }
}
...
void Ice::SetStatue(int x){
    this->Object::SetStatue(x);
    switch (x) {
    case 0:MeImage.load(":/Images/Object/Ice1.png");break;
    case 1:MeImage.load(":/Images/Object/Ice2.png");break;
    default:break;
    }
}
