...
private:
    ...
    void mousePressEvent(QMouseEvent *a)Q_DECL_OVERRIDE{CreateRedZone(QRect(a->x(),a->y(),0,0),200,1);}
    void mouseMoveEvent(QMouseEvent *ev) Q_DECL_OVERRIDE {Mouse_Point=ev->pos();}
};
