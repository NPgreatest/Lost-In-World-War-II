...
void EditMap::paintEvent(QPaintEvent *event){
    ...
    number[1].load(":/images/Wall1.png");
    number[2].load(":/images/BedRock1.png");
    number[3].load(":/images/River1.jpg");
    number[5].load(":/images/Camp1.jpg");
    number[6].load(":/images/FirstAid1.png");
    number[7].load(":/images/Weapon1.png");
    number[8].load("://images/Camp2.jpg");
    number[9].load("://images/FirstAid2.png");
    number[10].load("://images/Weapon2.png");
    number[11].load("://images/Camp3.jpg");
    number[12].load("://images/FirstAid3.png");
    number[13].load("://images/Weapon3.png");
    number[14].load("://images/Ruins1.png");
    number[15].load("://images/Grass1.png");
    number[16].load("://images/Nail.png");
    number[17].load("://images/ice1.png");
    number[101].load("://images/EnemyUp_1.png");
    number[102].load("://images/TankUp.png");
...
void EditMap::on_checkBox_2_stateChanged(int arg1)
{
    if(ui->checkBox_2->isChecked()==false){
      ...
      this->setStyleSheet("#EditMap{border-image:url(:/images/BattleGround.png);}");
    }
}
