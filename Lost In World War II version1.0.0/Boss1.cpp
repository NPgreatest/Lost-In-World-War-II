...
switch (this->head) {
case UP:t1.y=0;t2={150,this->pos.y};B3.Init(t1,t2,70);break;
case DOWN:t2={150,1000};B3.Init(t1,t2,70);break;
case LEFT:t1.x=0;t2={this->pos.x,150};B3.Init(t1,t2,70);break;
case RIGHT:t2={10000,150};B3.Init(t1,t2,70);break;
}
}
