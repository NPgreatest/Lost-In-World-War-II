...
void MainWindow::Tick(){
    ...
    for(i=0;i<5;i++)
    CreatePartical(XY(500+QRandomGenerator::global()->bounded(-50,50),180+QRandomGenerator::global()->bounded(-100,100)),XY(50,50),Type::Mist);
...
void MainWindow::CreatePartical(XY pos,XY area,Type type){
    int i;
...
void MainWindow::mouseMoveEvent(QMouseEvent *ev){
    ...
    case 1:CreatePartical(XY(ev->x()-10,ev->y()-10),XY(20,20),Type::Player_B3_UP);break;
    case 2:CreatePartical(XY(ev->x()-10,ev->y()-10),XY(20,20),Type::Player_B3_DOWN);break;
    case 3:CreatePartical(XY(ev->x()-10,ev->y()-10),XY(20,20),Type::Player_B3_LEFT);break;
    case 4:CreatePartical(XY(ev->x()-10,ev->y()-10),XY(20,20),Type::Player_B3_RIGHT);break;
    case 5:CreatePartical(XY(ev->x()-10,ev->y()-10),XY(20,20),Type::Object_Hit);break;
