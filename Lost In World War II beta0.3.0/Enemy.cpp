...
Enemy::Enemy(XY p,XY area,int hp,int speed,int bullet_speed,int skin)
{
    ...
    head=UP;alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Tank/EnemyUp_1.png");
    case 2:MeImage.load(":/Images/Tank/EnemyUp_2.png");
    case 3:MeImage.load(":/Images/Tank/EnemyUp_3.png");
    case 4:MeImage.load(":/Images/Tank/EnemyUp_4.png");
    case 5:MeImage.load(":/Images/Tank/EnemyUp_5.png");
    }
}
Enemy::Enemy()
{
