...
Wall::Wall(XY p,XY a,int skin,int HP):Object(p,a,skin,1){
    ...
    switch (this->HP) {
    case 2:MeImage.load(":/Images/Object/Wall2.png");break;
    case 1:MeImage.load(":/Images/Object/Wall3.png");break;
...
River::River(XY p,XY a,int skin):Object(p,a,skin,3){
...
Portal::Portal(XY p,XY a):Object(p,a,0,4){
...
FirstAid::FirstAid(XY p,XY a,int skin):Object(p,a,skin,6){
    MeRect.setRect(pos.x,pos.y,area.x,area.y);Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/FirstAid1.png");
    case 2:MeImage.load(":/Images/Object/FirstAid2.png");
    case 3:MeImage.load(":/Images/Object/FirstAid3.png");
    default:break;
    }
}
Weapon::Weapon(XY p,XY a,int skin):Object(p,a,skin,7){
    MeRect.setRect(pos.x,pos.y,area.x,area.y);Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/Weapon1.png");
    case 2:MeImage.load(":/Images/Object/Weapon2.png");
    case 3:MeImage.load(":/Images/Object/Weapon3.png");
    default:break;
    }
}
Ruins::Ruins(XY p,XY a,int skin):Object(p,a,skin,8){
    MeRect.setRect(pos.x,pos.y,area.x,area.y);Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/Ruins1.png");
    case 2:MeImage.load(":/Images/Object/Ruins2.png");
    default:break;
    }
}
Grass::Grass(XY p,XY a,int skin):Object(p,a,skin,9){
    MeRect.setRect(pos.x,pos.y,area.x,area.y);Alive=true;
    switch (skin) {
    case 1:MeImage.load(":/Images/Object/Grass1.png");
    case 2:MeImage.load(":/Images/Object/Grass1.png");
    default:break;
    }
}
