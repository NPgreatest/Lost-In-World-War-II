...
void BattleWindow::keyPressEvent(QKeyEvent *event){
    ...
    for(i=0;i<PLAYER_NUMBER_MAX;i++){
        ...
        if(!event->isAutoRepeat()){
            ...
            case 87:P1[i].Player_ChangeHead(0);move.start(10);break;
            case 83:P1[i].Player_ChangeHead(1);move.start(10);break;
            case 65:P1[i].Player_ChangeHead(2);move.start(10);break;
            case 68:P1[i].Player_ChangeHead(3);move.start(10);break;
            case 32:
                switch (P1[i].GetSkill().GetSkill()) {
                case SkillName::MainWeapon:if(!P1[i].Player_B1Fire())Play_MPOut();break;
                case SkillName::SubWeapon:
                    ...
                    double t1,t2,result;
                    t1=Mouse_Point.x()-P1[i].GetRect().center().x();
                    t2=Mouse_Point.y()-P1[i].GetRect().center().y();
                    result=atan(t1/t2);
                    if(t2<0) result+=3.1415926;
                    P1[i].Player_B2Fire(result);
                    P1[i].SetChoose(2);
                    break;
                case SkillName::Fire:if(P1[i].Player_B3Fire()){
                        switch (P1[i].GetHead()) {
                        case UP:CreatePartical(P1[i].GetRect().adjusted(-50,-100,60,-40),Type::Player_B3_UP);break;
                        case DOWN:CreatePartical(P1[i].GetRect().adjusted(-50,40,60,100),Type::Player_B3_DOWN);break;
                        case LEFT:CreatePartical(P1[i].GetRect().adjusted(-100,-50,-40,60),Type::Player_B3_LEFT);break;
                        case RIGHT:CreatePartical(P1[i].GetRect().adjusted(40,-50,110,60),Type::Player_B3_RIGHT);break;
                        }
                    }break;
                }break;
            case 76:
                if(P1[i].GetChoose()==1)
                    ...
                    P1[i].SetChoose(1);
                break;
            case 16777248:P1[i].GetSkill().SkillChange();break;
            case 61:
